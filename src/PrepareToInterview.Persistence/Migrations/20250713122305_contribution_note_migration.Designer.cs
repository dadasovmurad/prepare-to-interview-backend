...
namespace PrepareToInterview.Persistence.Migrations
{
    ...
    [Migration("20250713122305_contribution_note_migration")]
    partial class contribution_note_migration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrepareToInterview.Domain.Entities.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PrepareToInterview.Domain.Entities.Question", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_question_user_id");
            ...
            modelBuilder.Entity("PrepareToInterview.Domain.Entities.Contribution", b =>
                {
                    b.HasOne("PrepareToInterview.Domain.Entities.AppUser", "User")
                        .WithMany("Contributions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_contribution_app_user_user_id");
            ...
            modelBuilder.Entity("PrepareToInterview.Domain.Entities.Question", b =>
                {
                    ...
                    b.HasOne("PrepareToInterview.Domain.Entities.AppUser", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_question_app_user_user_id");
